...
func newDocument(db *gorm.DB, opts ...gen.DOOption) document {
	...
	_document.ID = field.NewField(tableName, "id")
	_document.OrgID = field.NewField(tableName, "org_id")
	_document.TeamID = field.NewField(tableName, "team_id")
	_document.SourceFileID = field.NewField(tableName, "source_file_id")
	_document.Title = field.NewString(tableName, "title")
	_document.MimeType = field.NewString(tableName, "mime_type")
	_document.SizeBytes = field.NewInt64(tableName, "size_bytes")
	_document.StoragePath = field.NewString(tableName, "storage_path")
	_document.ExtractedText = field.NewString(tableName, "extracted_text")
	_document.Summary = field.NewString(tableName, "summary")
	_document.Keywords = field.NewField(tableName, "keywords")
	_document.Entities = field.NewString(tableName, "entities")
	_document.Visibility = field.NewString(tableName, "visibility")
	_document.AccessControl = field.NewString(tableName, "access_control")
	_document.Indexed = field.NewBool(tableName, "indexed")
	_document.CreatedBy = field.NewField(tableName, "created_by")
...
func (d *document) updateTableName(table string) *document {
	...
	d.SourceFileID = field.NewField(table, "source_file_id")
	d.Title = field.NewString(table, "title")
	d.MimeType = field.NewString(table, "mime_type")
	d.SizeBytes = field.NewInt64(table, "size_bytes")
	d.StoragePath = field.NewString(table, "storage_path")
	d.ExtractedText = field.NewString(table, "extracted_text")
	d.Summary = field.NewString(table, "summary")
	d.Keywords = field.NewField(table, "keywords")
	d.Entities = field.NewString(table, "entities")
	d.Visibility = field.NewString(table, "visibility")
	d.AccessControl = field.NewString(table, "access_control")
	d.Indexed = field.NewBool(table, "indexed")
	d.CreatedBy = field.NewField(table, "created_by")
...
func (d *document) fillFieldMap() {
	...
	d.fieldMap["source_file_id"] = d.SourceFileID
	d.fieldMap["title"] = d.Title
	d.fieldMap["mime_type"] = d.MimeType
	d.fieldMap["size_bytes"] = d.SizeBytes
	d.fieldMap["storage_path"] = d.StoragePath
	d.fieldMap["extracted_text"] = d.ExtractedText
	d.fieldMap["summary"] = d.Summary
	d.fieldMap["keywords"] = d.Keywords
	d.fieldMap["entities"] = d.Entities
	d.fieldMap["visibility"] = d.Visibility
	d.fieldMap["access_control"] = d.AccessControl
	d.fieldMap["indexed"] = d.Indexed
